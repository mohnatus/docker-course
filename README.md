...
Для деплоя проекта на сервер:

- Залить пакет на docker hub (или в другое хранилище)
- Подключиться к серверу по ssh
- Выполняем те же самые команды, что и локально (скачать образ, создать контейнер с нужными настройками)
